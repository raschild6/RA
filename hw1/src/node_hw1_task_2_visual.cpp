...
void Correspondence_Grouping (const PointCloud<PointType>::ConstPtr &sceneConst, string filename, int i_cloud, float params[]){
	...
	//string namefile = "./src/hw1/test/CG_" + to_string(i_cloud) + "_" + nameMesh.c_str() + "_" + datetime + ".txt"; 
		...
		switch (color){
				...
				if(typeRun == 2){
					...
					*/
					...
					if(minPt.z >= 1.9){
						...
						filename = "./src/hw1/meshes/triangle_centered_cut_10k.pcd";
						...
						filename = "./src/hw1/meshes/cube_cut_10k.pcd";
			...
			case (3):		// yellow
				if(typeRun == 2){
					...
					filename = "./src/hw1/meshes/hexagon_cut_20k.pcd";
